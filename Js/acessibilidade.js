document.addEventListener('DOMContentLoaded', () => {
  ...
  increaseContrastButton.textContent = 'Increase Contrast';
  ...
  decreaseContrastButton.textContent = 'Decrease Contrast';
  ...
  sideWindow.appendChild(resetButton);
  ...
  // Add event listener to the increase contrast button
  increaseContrastButton.addEventListener('click', () => {
    contrastLevel += 10;
    document.body.style.filter = `contrast(${contrastLevel}%)`;
  });

  // Add event listener to the decrease contrast button
  ...
  const styles = `
    ...
    .font-button, .contrast-button, .reset-button {
      display: block;
      width: 100%;
    ...
    .font-button:hover, .contrast-button:hover, .reset-button:hover {
